...
public class timer extends AppCompatActivity {
    ...
    void notes(String date,String time,String name ,String timing ){
        try{

            SQLiteDatabase db = this.openOrCreateDatabase("timing",MODE_PRIVATE,null);
            db.execSQL("CREATE TABLE IF NOT EXISTS data(DATE VARCHAR,TIME VARCHAR,TIMING VARCHAR)");
            db.execSQL("INSERT INTO data VALUES('"+date+"','"+time+"','"+name+"','"+timing+"')");
